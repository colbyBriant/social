    ...
    "paths": {
        ...
        "/xkCourse/createXkCourse": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建XkCourse",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/testdb.XkCourse"
                        }
                    }
                ],
                "responses": {
        ...
        "/xkCourse/deleteXkCourseByIds": {
            "delete": {
                ...
                "summary": "批量删除XkCourse",
                "parameters": [
                    {
                        "description": "批量删除XkCourse",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
